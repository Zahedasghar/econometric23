...
```{r}
#| label: fig-hist
#| fig-cap: Histogram of credit limit
#| cap-location: margin
...
@fig-hist 25% (100) persons have credit limits between 0 and 3308 (low credit limit). 25% have between 3308 and 4622 (medium credit limit), 25% have credit limit between 4662 and 5873 (medium hight credit limit) and 25% have credit limit abot $\$5873$ (hig credit limit).
